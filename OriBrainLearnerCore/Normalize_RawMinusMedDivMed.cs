...
namespace LibSVMScale
{
    ...
    public class Normalize_RawMinusMedDivMed : NormalizationInterface
    {
        ...
        public void output(int index, double value)
        {
            ...
            double normalized_value = (value - Preferences.Instance.TrainingBaselineMedians[Preferences.Instance.currentProcessedRun].median[index - 1])
                                      / Preferences.Instance.TrainingBaselineMedians[Preferences.Instance.currentProcessedRun].median[index - 1];
        ...
        public void outputRealTime(int index, ref double value)
        {
            ...
            if ((value < feature_min[index]) || (value > feature_max[index]))
            {
                counter++;
            }
        ...
        public void outputRealTime_update(int index, ref double value)
        {
           ...
           //2nd smallest is in Preferences.Instance.medianRange.feature_max and _low
            
           //NOTE:check not needed in range, high and low may be the same number.
           /* skip single-valued attribute */
           //if (feature_max[index] == feature_min[index])
           //    return;
            ...
            double normalized_value = (value - Preferences.Instance.TestingBaselineStatistics.getMeanWhenIGIndicesSaved(index))
                                       / Preferences.Instance.TestingBaselineStatistics.getMeanWhenIGIndicesSaved(index);
