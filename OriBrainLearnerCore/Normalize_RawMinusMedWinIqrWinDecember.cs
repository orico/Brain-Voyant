...
namespace LibSVMScale
{
    ...
    public class Normalize_RawMinusMedWinIqrWinDecember : NormalizationInterface
    {
        ...
        public void output(int index, double value)
        {
            ...
            //if (Preferences.Instance.currentClassifiedVector < Preferences.Instance.events.eventList[0].var2)
                //return;
            double[] medianIQR = new double[2];/****************************************** = Preferences.Instance.TrainingBaselineMediansRunningWindow[Preferences.Instance.currentProcessedRun].
                CalcMedIQRRunningWindow(index - 1, TR, currentLine);*/
