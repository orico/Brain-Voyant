...
namespace LibSVMScale
{
    ...
    public class Normalize_RawMinusMedWin : NormalizationInterface
    {
        ...
        private bool useGrowingWindow = true;
        /// <summary>
        ...
        { 
            //if (Preferences.Instance.currentClassifiedVector < Preferences.Instance.events.eventList[0].var2)
                //return;
            double median = Preferences.Instance.TrainingBaselineMediansRunningWindow[Preferences.Instance.currentProcessedRun].
                TrainingCalcMedRunningWindow(index - 1, TR, currentLine, useGrowingWindow);

            double normalized_value;
            normalized_value = (value - median);
        ...
        public void outputRealTime_update(int index, ref double value)
        {
            ...
            //if (Preferences.Instance.currentClassifiedVector < Preferences.Instance.events.eventList[0].var2)
            //return;
            double median = Preferences.Instance.TestingBaselineMediansRunningWindow.TestingCalcMedRunningWindow(index - 1, Preferences.Instance.currentClassifiedVector,useGrowingWindow);
